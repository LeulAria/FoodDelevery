...
admin.site.site_title = _("FoodOrderBackend site admin")
admin.site.site_header = _("FoodOrderBackend Dashboard")
admin.site.index_title = _("Welcome to FoodOrderBackend")
